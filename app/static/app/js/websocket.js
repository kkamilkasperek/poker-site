...
const playingCards = {
    '2 of Spades': '/static/img/playing_cards/2_of_spades.png',
    '3 of Spades': '/static/img/playing_cards/3_of_spades.png',
    '4 of Spades': '/static/img/playing_cards/4_of_spades.png',
    '5 of Spades': '/static/img/playing_cards/5_of_spades.png',
    '6 of Spades': '/static/img/playing_cards/6_of_spades.png',
    '7 of Spades': '/static/img/playing_cards/7_of_spades.png',
    '8 of Spades': '/static/img/playing_cards/8_of_spades.png',
    '9 of Spades': '/static/img/playing_cards/9_of_spades.png',
    '10 of Spades': '/static/img/playing_cards/10_of_spades.png',
    'Jack of Spades': '/static/img/playing_cards/jack_of_spades.png',
    'Queen of Spades': '/static/img/playing_cards/queen_of_spades.png',
    'King of Spades': '/static/img/playing_cards/king_of_spades.png',
    'Ace of Spades': '/static/img/playing_cards/ace_of_spades.png',

    '2 of Hearts': '/static/img/playing_cards/2_of_hearts.png',
    '3 of Hearts': '/static/img/playing_cards/3_of_hearts.png',
    '4 of Hearts': '/static/img/playing_cards/4_of_hearts.png',
    '5 of Hearts': '/static/img/playing_cards/5_of_hearts.png',
    '6 of Hearts': '/static/img/playing_cards/6_of_hearts.png',
    '7 of Hearts': '/static/img/playing_cards/7_of_hearts.png',
    '8 of Hearts': '/static/img/playing_cards/8_of_hearts.png',
    '9 of Hearts': '/static/img/playing_cards/9_of_hearts.png',
    '10 of Hearts': '/static/img/playing_cards/10_of_hearts.png',
    'Jack of Hearts': '/static/img/playing_cards/jack_of_hearts.png',
    'Queen of Hearts': '/static/img/playing_cards/queen_of_hearts.png',
    'King of Hearts': '/static/img/playing_cards/king_of_hearts.png',
    'Ace of Hearts': '/static/img/playing_cards/ace_of_hearts.png',

    '2 of Diamonds': '/static/img/playing_cards/2_of_diamonds.png',
    '3 of Diamonds': '/static/img/playing_cards/3_of_diamonds.png',
    '4 of Diamonds': '/static/img/playing_cards/4_of_diamonds.png',
    '5 of Diamonds': '/static/img/playing_cards/5_of_diamonds.png',
    '6 of Diamonds': '/static/img/playing_cards/6_of_diamonds.png',
    '7 of Diamonds': '/static/img/playing_cards/7_of_diamonds.png',
    '8 of Diamonds': '/static/img/playing_cards/8_of_diamonds.png',
    '9 of Diamonds': '/static/img/playing_cards/9_of_diamonds.png',
    '10 of Diamonds': '/static/img/playing_cards/10_of_diamonds.png',
    'Jack of Diamonds': '/static/img/playing_cards/jack_of_diamonds.png',
    'Queen of Diamonds': '/static/img/playing_cards/queen_of_diamonds.png',
    'King of Diamonds': '/static/img/playing_cards/king_of_diamonds.png',
    'Ace of Diamonds': '/static/img/playing_cards/ace_of_diamonds.png',

    '2 of Clubs': '/static/img/playing_cards/2_of_clubs.png',
    '3 of Clubs': '/static/img/playing_cards/3_of_clubs.png',
    '4 of Clubs': '/static/img/playing_cards/4_of_clubs.png',
    '5 of Clubs': '/static/img/playing_cards/5_of_clubs.png',
    '6 of Clubs': '/static/img/playing_cards/6_of_clubs.png',
    '7 of Clubs': '/static/img/playing_cards/7_of_clubs.png',
    '8 of Clubs': '/static/img/playing_cards/8_of_clubs.png',
    '9 of Clubs': '/static/img/playing_cards/9_of_clubs.png',
    '10 of Clubs': '/static/img/playing_cards/10_of_clubs.png',
    'Jack of Clubs': '/static/img/playing_cards/jack_of_clubs.png',
    'Queen of Clubs': '/static/img/playing_cards/queen_of_clubs.png',
    'King of Clubs': '/static/img/playing_cards/king_of_clubs.png',
    'Ace of Clubs': '/static/img/playing_cards/ace_of_clubs.png',

    'reverse': '/static/img/playing_cards/reverse2-copy.png',
};
        ...
        if (pos !== yourPosition) {
            ...
            if (seatDiv) {
                ...
                if (playerCardsDiv) {
                    ...
                    for (let i = 0; i < 2; i++) {
                        const img = document.createElement("img")
                        img.src = '/static/img/playing_cards/reverse2-copy.png';
                        img.alt = 'reverse';
                        playerCardsDiv.appendChild(img);
                    }
                }
